        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        {!! Form::label(__('Site:')) !!}
                        {!! Form::text("site_conv", $convenio->site_conv ,["class"=>"form-control mmss","required"=>"required"]) !!}
                    </div>
